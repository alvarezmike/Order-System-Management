...
//Coded by Michael Alvarez
//Advanced Java Course Project
//Week 4 - Adding Project To Github
public class cart
{
	...
	public static void main(String[] args)
	{
        ...
        // create logRecords
        LogRecord record1 = new LogRecord(Level.INFO, "Week 4");
        LogRecord record2 = new LogRecord(Level.INFO,"Adding Project to Github");
  // log messages using
  // log(LogRecord record)
		...
		char decision;
		System.out.println("================================================================");
		System.out.println("Welcome to Mike's Burger, please choose any of the menu there..");
		do
		{ 
			//Showcase the products available in the menu 
